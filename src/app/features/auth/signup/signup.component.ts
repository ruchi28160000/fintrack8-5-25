...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule, RouterModule, HttpClientModule, FormsModule], // Added FormsModule
...
export class SignupComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.signupForm = this.fb.group(

      {
        ...
        verificationCode: [''], // Added for email verification
  ...
  sendVerificationCode(): void {
    ...
    this.errorMessage = ''; // ✅ Clear previous errors here
